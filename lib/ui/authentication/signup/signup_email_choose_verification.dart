...
import 'package:meroshopping_flutter/ui/authentication/signup/signup_email_verification.dart';
...
class SignupEmailChooseVerificationPage extends StatefulWidget {
  ...
  const SignupEmailChooseVerificationPage({Key? key, this.email = ''})
      : super(key: key);

  @override
  _SignupEmailChooseVerificationPageState createState() =>
      _SignupEmailChooseVerificationPageState();
}

class _SignupEmailChooseVerificationPageState
    extends State<SignupEmailChooseVerificationPage> {
  @override
  void initState() {
    super.initState();
  }
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        SignupEmailVerificationPage(email: widget.email)));
          },
          child: Card(
