...
import 'package:meroshopping_flutter/ui/authentication/signup/signup_email.dart';
...
class SignupEmailVerificationPage extends StatefulWidget {
  ...
  const SignupEmailVerificationPage({Key? key, this.email = ''})
      : super(key: key);

  @override
  _SignupEmailVerificationPageState createState() =>
                  ...
                  onPressed: () {
                    if (!_buttonDisabled) {
                      ...
                      Navigator.of(context).pushAndRemoveUntil(
                          MaterialPageRoute(
                              builder: (context) =>
                                  SignupEmailPage(email: widget.email)),
