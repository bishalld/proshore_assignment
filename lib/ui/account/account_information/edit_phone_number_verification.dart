...
class EditPhoneNumberVerificationPage extends StatefulWidget {
  ...
  const EditPhoneNumberVerificationPage(
      {Key? key, this.verificationType = 'sms', this.phoneNumber = ''})
      : super(key: key);

  @override
  _EditPhoneNumberVerificationPageState createState() =>
      _EditPhoneNumberVerificationPageState();
}

class _EditPhoneNumberVerificationPageState
    extends State<EditPhoneNumberVerificationPage> {
        ...
        Container(
          ...
          child: Text(
            AppLocalizations.of(context)!
                    .translate('enter_verification_code_message2')! +
                ((widget.verificationType == 'wa')
                  ...
                  onPressed: () {
                    if (!_isButtonDisabled) {
                      ...
                      _globalFunction.startLoading(
                          context,
                          AppLocalizations.of(context)!
                              .translate('edit_phone_number_success')!,
                          2);
              ...
              GestureDetector(
                onTap: () {
                  _globalFunction.resendVerification(
                      context,
                      AppLocalizations.of(context)!
                          .translate('resend_verification_message_phone')!);
                },
                child: Text(
