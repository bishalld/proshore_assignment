...
import 'package:meroshopping_flutter/ui/account/account_information/edit_phone_number_verification.dart';
...
class EditPhoneNumberChooseVerificationPage extends StatefulWidget {
  ...
  const EditPhoneNumberChooseVerificationPage({Key? key, this.phoneNumber = ''})
      : super(key: key);

  @override
  _EditPhoneNumberChooseVerificationPageState createState() =>
      _EditPhoneNumberChooseVerificationPageState();
}

class _EditPhoneNumberChooseVerificationPageState
    extends State<EditPhoneNumberChooseVerificationPage> {
  @override
  void initState() {
    super.initState();
  }
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) => EditPhoneNumberVerificationPage(
