...
import 'package:meroshopping_flutter/ui/account/account_information/edit_email_verification.dart';
...
class EditEmailChooseVerificationPage extends StatefulWidget {
  ...
  const EditEmailChooseVerificationPage({Key? key, this.email = ''})
      : super(key: key);

  @override
  _EditEmailChooseVerificationPageState createState() =>
      _EditEmailChooseVerificationPageState();
}

class _EditEmailChooseVerificationPageState
    extends State<EditEmailChooseVerificationPage> {
  @override
  void initState() {
    super.initState();
  }
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        EditEmailVerificationPage(email: widget.email)));
          },
          child: Card(
