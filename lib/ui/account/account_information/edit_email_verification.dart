/*
This is edit email verification page
...
class EditEmailVerificationPage extends StatefulWidget {
  final String email;

  const EditEmailVerificationPage({Key? key, this.email = ''})
      : super(key: key);

  @override
  _EditEmailVerificationPageState createState() =>
      _EditEmailVerificationPageState();
}

class _EditEmailVerificationPageState extends State<EditEmailVerificationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        Center(child: Icon(Icons.email, color: PRIMARY_COLOR, size: 50)),
        SizedBox(height: 20),
        Center(
            child: Text(
        ...
        Container(
          ...
          child: Text(
            AppLocalizations.of(context)!
                    .translate('enter_verification_code_message')! +
                widget.email,
        ...
        Center(
          child: Wrap(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  _globalFunction.resendVerification(
                      context,
                      AppLocalizations.of(context)!
                          .translate('resend_verification_message_email')!);
                },
                child: Text(
