...
import 'package:meroshopping_flutter/ui/account/payment_method/add_payment_method.dart';
import 'package:meroshopping_flutter/ui/account/payment_method/edit_payment_method.dart';
        ...
        body: ListView(
          ...
          children: [
            Text("E-sewa",
                ...
                //     .translate('default_payment_pref')!,
                style: TextStyle(
                    fontSize: 16,
                  ...
                  rows: <DataRow>[
                    DataRow(
                      cells: <DataCell>[
                        DataCell(Row(
                          children: [
                            Image.asset('assets/icons/esewa_icon.png',
                                height: 30),
                            SizedBox(width: 5),
                            // Container(
                            //   margin: EdgeInsets.only(right: 8),
